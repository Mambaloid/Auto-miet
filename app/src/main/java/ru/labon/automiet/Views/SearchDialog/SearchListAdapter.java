package ru.labon.automiet.Views.SearchDialog;
...
public class SearchListAdapter extends ArrayAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView tv = inflateview.findViewById(textviewResourceID);
        TextView tvNumber = inflateview.findViewById(R.id.textNumber);
        tv.setText(searchListItems.get(i).getTitle());
        String number = (i + 1) < 10 ? (i + 1) + "   " : ((i + 1) < 100 ? (i + 1) + "  " : (i + 1) + "");
